...
<form  method="POST" class="form-container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label style="font-weight: 600;" for="careForSomeone" class="form-label">Are You caring for someone within this period ?</label>
                <select class="form-select genderSelector" name="careForSomeone" id="careForSomeone" value="{{ old('careForSomeone') }}" required>
                    <option value="default">Please select a value </option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
            
                </select>
                <span class="text-danger" id="careForSomeone-error"></span>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="form-group">
                        <button type="button" id="back-carer" class="btn btn-light btn-block rounded border border-grey">Back</button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
<div id="previewDetails">
    <div class="row justify-content-center">
        ...
        <form id="register-form" method="POST" class="form-container">
            ...
            <h8 style="font-weight: 600;" class="mt-4 mb-4">Carer Details</h8>

            <div  class="row">
                <div class="col-md-6">
                    <label>Are You caring for someone within this period ?</label>
                </div>
                <div class="col-md-6">
                    <label id="previewCareForSomeone"></label>
                </div>
            </div>


            <div id="previewPersonCaredRow" class="row">
                <div class="col-md-6">
                    <label>Who are you caring for ?</label>
                </div>
                <div class="col-md-6">
                    <label id="previewPersonCared"></label>
                </div>
            </div>
