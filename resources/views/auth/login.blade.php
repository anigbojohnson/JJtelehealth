...
<div class="container">
    <div class="row justify-content-center">
        ...
        @endif 
            ...
            <form method="POST" action="{{ route('login', ['param' =>  Str::slug($param), 'action'=>$action ]) }}" class="form-container">
                @csrf
            ...
            <p>If you are not registered, <a href="{{ route('register') }}">click here</a> to register.</p>
            <a href="/auth/microsoft/redirect" class="btn btn-microsoft btn-block border">
                <i class="fab fa-microsoft"></i> Login with Microsoft
            </a>  
            <a href="/auth/google/redirect" class="btn btn-google btn-block border">
