        ...
        <div class="row justify-content-center">
            ...
            <form id="register-form" method="POST" class="form-container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                              <input type="radio" id="sickLeave" name="work" value="Sick Leave From Work">
                              <label for="sickLeave">Sick leave from work </label><br>
                              <input type="radio" id="FitToReturn" name="work" value="Fit to return to work">
                              <label for="FitToReturn">Fit to return to work</label><br>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                              <input type="radio" id="startWork" name="work" value="Fit to start work">
                              <label for="startWork">Fit to start work </label><br>
                              <input type="radio" id="adjustWork" name="work" value="Adjust work duties">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label style="font-weight: 600;" for="dob" class="form-label">Please confirm where you work</label>
                            <input id="placeYouWork" type="text" name="placeYouWork" value="{{ old('placeYouWork') }}" required autocomplete="placeYouWork" autofocus class="form-control">
                            <span class="text-danger" id="placeYouWork-error"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label style="font-weight: 600;" for="dailyWorkActivities" class="form-label">Please describe your daily work activities</label>
                            <input id="dailyWorkActivities" type="text" name="dailyWorkActivities" value="{{ old('dailyWorkActivities') }}" required autocomplete="dailyWorkActivities" autofocus class="form-control">
                            <p style="font-size: 10px;">i.e Desk Job, Travelling , Driving</p>
                            <span class="text-danger" id="dailyWorkActivities-error"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" id="workAdjustments">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="adjustmentsReasons" type="text" name="adjustmentsReasons" value="{{ old('adjustmentsReasons') }}" required autocomplete="adjustmentsReasons" autofocus class="form-control">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <button type="button" id="validate-work-details" class="btn btn-dark btn-block">Continue</button>
                        </div>
                    </div>
                </div>
            </form>
...
<div id="previewDetails">
    <div class="row justify-content-center">
        ...
        <form id="register-form" method="POST" class="form-container" action="{{ route('submit-work-medical-certificate') }}">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label id="previewPlaceYouWork"></label>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label id="previewDailyWorkActivities"></label>
                </div>
            </div>

            <div id="previewIAgreeRow" class="row">
                <div class="col-md-6">
                    <label> Acknowledge that I do not hold some outlined roles</label>
                </div>
                <div class="col-md-6">
                    <label id="previewIAgree"></label>
                </div>
            </div>
            <div id="previewAdjustmentsActivitiesRow" class="row">
                <div class="col-md-6">
                    <label>What work adjustments do you require?</label>
                </div>
                <div class="col-md-6">
                    <label id="previewAdjustmentsActivities"></label>
                </div>
            </div>
            ...
            <div  class="row previewMedicalLetterReasons">
                <div class="col-md-6">
