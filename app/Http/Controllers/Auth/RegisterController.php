...
class RegisterController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $checkUser = User::where('email', trim($request->email))
        ...
        $user->provider = 'form register';
        if($user->save()){
            
         
            $this->emailVerificationService->sendVerificationLink($user, "verify-email");
            return redirect()->route('showRegistrationForm')->with('success', 'Please check your email to verify and complete registration .');
